...
public class VistaClienteCabecera {
	public JPanel content;
	private String nombreTabla = "CLIENTE CABECERA";
	...
	public JTextField ideCliente = new JTextField(10);
	...
	public void createAddPanelContent(){
		addPanel.add(new JLabel("Registro de Cliente Cabecera"), BorderLayout.NORTH);
		...
		JPanel ideClientePanel = new JPanel(new GridLayout(1,2));
		JLabel ideClienteLabel = new JLabel("Ide Cliente:");
		ideClienteLabel.setHorizontalAlignment(JLabel.CENTER);

		ideClientePanel.add(ideClienteLabel);

		JPanel ideClienteButtonPanel = new JPanel(new FlowLayout());

		ideClienteButtonPanel.add(ideCliente);
		ideClientePanel.add(ideClienteButtonPanel);
	...
	public void createViewPanelContent(){
		...
		tabla.setModel(new javax.swing.table.DefaultTableModel(
					null,
					new String [] {
						"IdeFactura", "IdeCliente", "EstadoRegistro"
					}
					));
