...
public class VistaClienteFacturaProducto {
    ...
    public JPanel createTabla1Panel() {
        ...
        int count = 6;
        String cols[] = { "Nombre", "Ap. Paterno", "Ap. Materno", "Importe", "Cantidad", "Producto", };
        int colsType[] = { 0, 0, 0, 1, 1, 0};
        String tableName = "vistaClienteFacturaProducto"; // nombre de la vista
        String name = "Venta"; // nombre de la tabla
    ...
    public JPanel createTableContent(int colsCount, String cols[], int colsType[], String tableName, String name) {
        ...
        try {
            ...
            Object[][] objetos = new Object[15][colsCount];
