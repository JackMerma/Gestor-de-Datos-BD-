...
public class VistaAcciones {
	public JPanel content;
	private String nombreTabla = "ACCIONES";
	...
	public JTextField ideHist = new JTextField(10);
	...
	public void createAddPanelContent(){
		addPanel.add(new JLabel("Registro de Acciones"), BorderLayout.NORTH);
		...
		JLabel ideLabel = new JLabel("Ide de usuario:");
		...
		JPanel ideHistPanel = new JPanel(new GridLayout(1,2));
		JLabel ideHistLabel = new JLabel("Ide de historia:");
		ideHistLabel.setHorizontalAlignment(JLabel.CENTER);

		ideHistPanel.add(ideHistLabel);

		JPanel ideHistButtonPanel = new JPanel(new FlowLayout());
		//createPanelWidth(ideHistButtonPanel, true, true, false, false);

		ideHistButtonPanel.add(ideHist);
		ideHistPanel.add(ideHistButtonPanel);
		...
		addPanelContentContent.add(ideHistPanel);
	...
	public void createViewPanelContent(){
		...
		tabla.setModel(new javax.swing.table.DefaultTableModel(
					null,
					new String [] {
						"IdeUsuario", "IdeHistoria", "EstadoRegistro"
					}
					));
