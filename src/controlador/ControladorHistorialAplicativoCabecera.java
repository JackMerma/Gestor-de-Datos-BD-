...
import javax.swing.*;
import src.modelo.HistorialAplicativoCabecera.HistorialAplicativoCabecera;
import src.modelo.HistorialAplicativoCabecera.HistorialAplicativoCabeceraDAO;
import src.vista.VistaHistorialAplicativoCabecera;

import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import java.util.ArrayList;

public class ControladorHistorialAplicativoCabecera extends Controlador<HistorialAplicativoCabecera> {

	public VistaHistorialAplicativoCabecera vista = (VistaHistorialAplicativoCabecera) vistaSuper;
	public static HistorialAplicativoCabeceraDAO historialAplicativoCabeceraDAO = new HistorialAplicativoCabeceraDAO();

	private int CarFlaAct = 0;
	private int action; // 1: agregar,

	// constructor de la clase, se pasan los parametros de la vistaEspecifica
	public ControladorHistorialAplicativoCabecera(VistaHistorialAplicativoCabecera v) {
		super(v, historialAplicativoCabeceraDAO);
		this.vista = v;
		listar(vista.tabla);
	}
	...
	@Override
	public HistorialAplicativoCabecera getOficinaDetalle() {
		HistorialAplicativoCabecera classInterna = new HistorialAplicativoCabecera();
		String ide = vista.ide.getText();
		String ideHistoria = vista.ideHistoria.getText();
		String estaRegis = vista.estaRegis.getText();

		// Creamos un objeto
		classInterna.setIdeFactura(Integer.parseInt(ide));
	...
	public void listar(JTable tabla) {
		...
		ArrayList<HistorialAplicativoCabecera> lista = historialAplicativoCabeceraDAO.listar();
		Object[] objeto = new Object[3]; // cambiar segun el numero de atributos


		for (int i = 0; i < lista.size(); i++) {
			objeto[0] = lista.get(i).getIdeFactura();
